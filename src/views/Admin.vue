<template>
  <div>
              ...
              <li v-for="(item, index) in goodsList" :key="index">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-title">
                    <div class="item-name">{{item.productId}}---------------{{item.productName}}</div>
                  </div>
                </div>
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <!-- <a href="javascript:;" class="item-edit-btn xg">修改</a> -->
                    <a
                      href="javascript:;"
                      class="item-edit-btn ljt"
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            <div class="cart-foot-r">
              <div class="btn-wrap">
                <a class="btn btn--red" @click.prevent="addFlag=true">添加</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- 添加商品框 -->
    <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':addFlag}">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title">添加商品框</div>
          <button class="md-close" @click="addFlag=false">Close</button>
        </div>
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="addErrorTip">商品id已存在</span>
            </div>
            <ul>
          ...
          <div class="login-wrap">
            <a href="javascript:;" class="btn-login" @click="addGoods">添加</a>
          </div>
        </div>
      </div>
    </div>
    <div class="md-overlay" v-if="addFlag" @click="addFlag=false"></div>
    <modal :mdShow="mdConfirm" v-on:close="closeModal">
      <p slot="message">你确认要删除此条商品吗</p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="del()">确认</a>
